            ...
            <div className="max-w-3xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/shopper/account" className="text-zinc-400 text-sm hover:text-white transition">
                            My account
                        </Link>
                        {view === 'list' && (
                            <button
                            ...
                            <>
                                ...
                                <div>
                                    <label className="block text-sm text-zinc-400 mb-1">
                                        Order reference <span className="text-zinc-600">(optional)</span>
                                    </label>
                                    <input
                                        value={orderRef}
